...
MariaDB [csd2204s18]> select depatment_id ,department_name from departments where department_name like 'IT%';
ERROR 1054 (42S22): Unknown column 'depatment_id' in 'field list'
...
MariaDB [csd2204s18]> select first_name,last_name,department,department_id from employees where department_id = (select department_id from departments where department_name like 'IT%');
...
MariaDB [csd2204s18]> select location_id ,counytry_id from locations where country_id = 'US';
ERROR 1054 (42S22): Unknown column 'counytry_id' in 'field list'
...
MariaDB [csd2204s18]> select first_name,last_name from employees where manager_id !=0 and select department_id in(select department_id from departments where location_id in (select location_id from locations where country_id = 'US'));
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'select department_id in(select department_id from departments where location_id ' at line 1
...
select distinct(manager_id) from employees where manager_id != 0' at line 1
MariaDB [csd2204s18]> select distinct(manager_id) from employees where manager_id != '0';
+------------+
| manager_id |
+------------+
...
MariaDB [csd2204s18]> select first_name,last_name,salary,job_id from employees where salary=(select min_salary from jobs where employees.job_id = job.job_id);
ERROR 1054 (42S22): Unknown column 'job.job_id' in 'where clause'
