...
MariaDB [csd2204s18]> SELECT COUNT(*),manfacturer
    -> from product as p
    -> INNER JOIN manu m
...
MariaDB [csd2204s18]> SELECT COUNT(*),manfacturer
    ...
    -> ON m.code = p.manufacturer
    -> group by manufacturer;
ERROR 1054 (42S22): Unknown column 'manfacturer' in 'field list'
...
MariaDB [csd2204s18]> SELECT manufacturer , m.name , COUNT(*) "No. of items produced", from products as p INNE
    ...
    -> ON m.Code = p.manufacturer
    -> group by manufacturer;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'from products as p INNE
inner join manu m
ON m.Code = p.manufacturer
group by ma' at line 1
MariaDB [csd2204s18]> SELECT manufacturer , m.name , COUNT(*) "No. of items produced", from products as p INNER
    -> inner join manu m
    -> ON m.Code = p.manufacturer
    -> group by manufacturer;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'from products as p INNER
inner join manu m
ON m.Code = p.manufacturer
group by m' at line 1
MariaDB [csd2204s18]> SELECT manufacturer , m.name , COUNT(*) "No. of items produced", from products as p 
    -> inner join manu m
    -> ON m.Code = p.manufacturer
    -> group by manufacturer;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'from products as p 
inner join manu m
ON m.Code = p.manufacturer
group by manufa' at line 1
MariaDB [csd2204s18]> select manufacturer, m.name,count(*)"No. of items" from products as p inner join manu m
    -> ON m.Code = p.manufacturer
    -> group by manufacturer;
+--------------+-------------------+--------------+
...
MariaDB [csd2204s18]> select count(*),p.manufacturer,m.name from products as pinner join manu m
    -> ON m.code = p.manufacturer
    -> having count(*)>2;
ERROR 1054 (42S22): Unknown column 'p.manufacturer' in 'field list'
...
MariaDB [csd2204s18]> select count(*)"no. of count",manufacturer from products as p inner join manu m on m.code =p.manufacturer group by manufacturer havimg count(*)>2;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'havimg count(*)>2' at line 1
...
MariaDB [csd2204s18]> select count(*)"no. of count",manufacturer from products as p inner join manu m on m.code =p.manufacturer where p.manufacturer like %drive group by manufacturer;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near '%drive group by manufacturer' at line 1
MariaDB [csd2204s18]> select count(*)"no. of count",manufacturer from products as p inner join manu m on m.code =p.manufacturer where p.manufacturer like '%drive';
+--------------+--------------+
| no. of count | manufacturer |
+--------------+--------------+
|            0 |         NULL |
...
MariaDB [csd2204s18]> select count(*)"no. of count",manufacturer from products as p inner join manu m on m.code =p.manufacturer where p.manufacturer like '%Labs' group by manufacturer;
Empty set (0.00 sec)
